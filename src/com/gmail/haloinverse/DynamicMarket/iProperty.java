...
/*     */{
    ...
    /*     */{
        /*     */try {
            ...
            /* 62 */log
                    .log(Level.SEVERE, "Unable to load " + this.fileName, ex);
            /*     */}
        /*     */}
    ...
    /*     */public void save() {
        /*     */try {
            /* 68 */this.properties.store(new FileOutputStream(this.fileName),
                    "Minecraft Properties File");
            /*     */} catch (IOException ex) {
            /* 70 */log
                    .log(Level.SEVERE, "Unable to save " + this.fileName, ex);
            /*     */}
        /*     */}
    ...
    /*     */public Map<String, String> returnMap() throws Exception {
        ...
        /* 76 */BufferedReader reader = new BufferedReader(new FileReader(
                this.fileName));
        /*     */
        /*     */String line;
    ...
    /*     */public double getDouble(String key) {
        /* 147 */if (this.properties.containsKey(key)) {
            /* 148 */return Double
                    .parseDouble(this.properties.getProperty(key));
            /*     */}
        /*     */
        /* 151 */return 0.0D;
        /*     */}
    ...
    /*     */public boolean getBoolean(String key) {
        /* 191 */if (this.properties.containsKey(key)) {
            /* 192 */return Boolean.parseBoolean(this.properties
                    .getProperty(key));
            /*     */}
        /*     */
        /* 195 */return false;
    ...
    /*     */public boolean getBoolean(String key, boolean value) {
        /* 199 */if (this.properties.containsKey(key)) {
            /* 200 */return Boolean.parseBoolean(this.properties
                    .getProperty(key));
            /*     */}
        /*     */
 ...
 * com.nijikokun.bukkit.SimpleShop.iProperty Java Class Version: 5 (49.0)

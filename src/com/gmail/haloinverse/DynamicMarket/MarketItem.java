...
public class MarketItem extends ItemClump {
    ...
    public String infoStringBuy(int numBundles) {
        ...
        return ("{}Buy: {BKT}[{PRM}" + formatBundleCount(numBundles) + "{BKT}]{} for {PRM}" + DynamicMarket.iConomy.getBank().format(getBuyPrice(numBundles)));
    ...
    public String infoStringSell(int numBundles) {
        ...
        // Display count as [<bundle>(x<numbundles>)]
        return ("{}Sell: {BKT}[{PRM}" + formatBundleCount(numBundles) + "{BKT}]{} for {PRM}" + DynamicMarket.iConomy.getBank().format(getSellPrice(numBundles)));
        //TODO: Abstract currency name from iConomy reference.
    }
